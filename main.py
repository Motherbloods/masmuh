...
<HomeScreen>:
    ...
    FloatLayout:
        Video:
            id: video_home
            source: 'Bghome.mp4'  # Video for the background
            state: 'play'
            options: {'eos': 'loop'}
            allow_stretch: True
            keep_ratio: False
    ...
    FloatLayout:
        ...
        ScrollView:
            ...
            GridLayout:
                ...
                padding: 10
                size_hint_y: None
                height: self.minimum_height  # Ensures GridLayout expands with content
...
<QuizScreen>:
    ...
    FloatLayout:
        Video:
            id: video_quiz
            source: 'BgQuiz.mp4'  # Video for the background
            state: 'play'
            options: {'eos': 'loop'}
            allow_stretch: True
            keep_ratio: False
...
<LevelScreen>:
    ...
    FloatLayout:
        Video:
            id: video_level
            source: 'BgSoal.mp4'  # Ganti dengan video latar yang diinginkan
            state: 'play'
            options: {'eos': 'loop'}
            allow_stretch: True
            keep_ratio: False
        ...
        BoxLayout:
            ...
            padding: 20
            spacing: 10
            size_hint: (0.7, 0.7)  # Tambahkan size_hint agar komponen lebih kecil dari video
